...
from apps.api.app.ingestion.models import IngestionRun, IngestionRunItem, ManifestEntry
        ...
        *,
        ...
        await self._session.execute(
            text("""
                ...
                VALUES (:run_id,:tenant_id,'ACQUISITION','QUEUED',:actor_user_id,
        ...
        await self.audit(
            tenant_id,
            actor_user_id,
            "KNOWLEDGE_ACQUISITION_RUN_CREATED",
            "INGESTION_RUN",
            run_id,
