...
class Permission(StrEnum):
    ...
    ADMIN_IDENTITY_WRITE = "ADMIN_IDENTITY_WRITE"
    ADMIN_CONFIG_READ = "ADMIN_CONFIG_READ"
    ADMIN_CONFIG_WRITE = "ADMIN_CONFIG_WRITE"
    ...
    KNOWLEDGE_MANIFEST_IMPORT = "KNOWLEDGE_MANIFEST_IMPORT"
    KNOWLEDGE_MANIFEST_APPROVE = "KNOWLEDGE_MANIFEST_APPROVE"
    KNOWLEDGE_INGESTION_RUN_CREATE = "KNOWLEDGE_INGESTION_RUN_CREATE"
    KNOWLEDGE_DOCUMENT_UPLOAD = "KNOWLEDGE_DOCUMENT_UPLOAD"
    KNOWLEDGE_DOCUMENT_READ_ADMIN = "KNOWLEDGE_DOCUMENT_READ_ADMIN"
    KNOWLEDGE_DOCUMENT_APPROVE = "KNOWLEDGE_DOCUMENT_APPROVE"
    KNOWLEDGE_DOCUMENT_PUBLISH = "KNOWLEDGE_DOCUMENT_PUBLISH"
...
for employee_knowledge_role in (
    ...
    ROLE_PERMISSIONS[employee_knowledge_role] |= frozenset(
...
ROLE_PERMISSIONS["PLATFORM_ADMIN"] |= frozenset(
    {
        ...
        Permission.KNOWLEDGE_INGESTION_RUN_CREATE,
        Permission.KNOWLEDGE_DOCUMENT_UPLOAD,
        Permission.KNOWLEDGE_DOCUMENT_READ_ADMIN,
        Permission.KNOWLEDGE_DOCUMENT_APPROVE,
        Permission.KNOWLEDGE_DOCUMENT_PUBLISH,
        Permission.KNOWLEDGE_DOCUMENT_RETIRE,
    }
)
...
ROLE_PERMISSIONS["PLATFORM_ADMIN"] |= frozenset(
    {Permission.SYSTEM_HEALTH_READ, Permission.AUDIT_EVENT_READ}
)
ROLE_PERMISSIONS["AUDITOR"] |= frozenset({Permission.AUDIT_EVENT_READ})
