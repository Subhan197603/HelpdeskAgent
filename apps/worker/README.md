...
The worker consumes tenant-scoped SLA and notification events from the PostgreSQL transactional outbox and
...
limit. Notification delivery also stores immutable attempts and never logs recipients or rendered
message content.
